...
class ContactController extends Controller
{
    ...
    */
    ...
    public function postSend(Request $request)
    {
        ...
        if($v->fails()){
            return ['status' => 'danger' , 'title' => 'فشل عمليه الارسال','msg' => implode('<br>',$v->errors()->all())];
        }
    ...
    */
    protected function validateContactForm($request) {
        $v = validator($request->all(), [
            ...
            "email.required" => "الايميل لا يمكن ان يكون فارغا.",
    ...
    */
    ...
    public function postSubscribe(Request $request)
    {
        ...
        return ['status' => 'success' , 'title' => 'نجاح عمليه الارسال','msg' => 'تم الاشتراك بنجاح سوف يتم تنبيهك بكل ما هو جديد.'];
    }
    /**
