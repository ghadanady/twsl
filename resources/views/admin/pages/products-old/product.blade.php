                ...
                <div class="table-responsive">
                    <table id="example" class="table table-bordered table-striped table-responsive">
                        ...
                        <td class="text-center">
                            ...
                            <a data-url="products/products/delete/{{$detail->master_id}}" class="btn btn-danger btndelet"  >
...
@endsection
@section('modals')
@include('admin.pages.products.modals.add')
@include('admin.pages.products.modals.newlang')
@endsection
