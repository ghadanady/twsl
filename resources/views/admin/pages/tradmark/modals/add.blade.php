...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{url('admin/trademark/add')}}" class="ajax-form" enctype="multipart/form-data" method="post"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                         <div class="form-group col-sm-12">
                            <label>الاسم </label>
                            <input type="text" class="form-control required" placeholder="google"  name="name">
                        </div>
                    </div>
                     <div class="row">
                        <div class="form-group col-sm-12">
