...
<head>
  ...
  <title>{{ $settings->site_name}} | Recover Password Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="{{ url('admin') }}">{{ $settings->site_name }}</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">استعادة كلمة المرور</p>
    @include('admin.layouts.alerts')
    <form action="{{url('admin/auth/recover-password')}}" method="post">
    {!! csrf_field() !!}
      <div class="form-group has-feedback">
        <input type="email" name="email" class="form-control" placeholder="البريد الأليكترونى" required>
